...
MR_PATTERNS = [
    ...
    r"\b(?P<base>methyl)\s+red\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:53:43 (54x)     r"\b(?P<base>methyl)\s+red\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:53:43 (54x)
...
FERMENTATION_PATTERNS = [
    ...
    r"\bmannitol\ fermentation\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:38:41 (77x)
    r"\bsucrose\ fermentation\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:38:41 (99x)
    r"\blactose\ fermentation\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:38:41 (139x)
    r"\bxylose\ fermentation\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:38:41 (28x)
    r"\barabinose\ fermentation\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:38:41 (12x)
    r"\bglucose\ fermentation\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:38:41 (195x)
    r"\bsorbitol\ fermentation\b.*(?:positive|detected|produced)",  # auto-learned 2025-11-10 23:38:41 (11x)
